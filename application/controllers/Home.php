  <?php 
	class Home extends CI_Controller
	{
		...
		public function sukses($id_pendaftar){
			$data['user'] = $this->db->get_where('tb_user', ['id_user' => $this->session->userdata('id_user')])->row_array();
			$data['pendaftar'] = $this->db->get_where('tb_pendaftar', ['id_pendaftar' => $id_pendaftar])->row_array();
		...
		public function send_transaction(){
			$data['user'] = $this->db->get_where('tb_user', ['id_user' => $this->session->userdata('id_user')])->row_array();
			$data['pendaftar'] = $this->db->get_where('tb_pendaftar')->result_array();
